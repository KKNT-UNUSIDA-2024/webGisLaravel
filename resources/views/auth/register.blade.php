                    ...
                    <div class="col-lg-8 col-md-10 ml-auto mr-auto">
                        <div class="card card-register card-white">
                            <div class="card-header">
                                ...
                                <h4 class="card-title font">Register</h4>
                            </div>
                            <div class="card-body">
                                <form class="form" action="{{ route('register') }}" method="post">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{-- <x-input-label for="name" :value="__('Name')" /> --}}
                                        <x-text-input id="name" class="form-control" placeholder="Full Name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <x-text-input id="password" class="form-control" placeholder="Email" type="email" name="email" :value="old('email')" required autocomplete="username" />
                                        <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
